...
export default function DataSummary({ data }: DataSummaryProps) {
  ...
  return (
    ...
    >
      <h3 className="text-2xl font-bold text-gray-800 mb-4">Data Summary</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="bg-white/10 rounded-lg p-4">
          <p className="text-gray-600 text-sm mb-1">Columns</p>
          <p className="text-3xl font-bold text-gray-800">{columnCount}</p>
        </div>
        <div className="bg-white/10 rounded-lg p-4">
          <p className="text-gray-600 text-sm mb-1">Data Quality</p>
      ...
      {data?.columns && data.columns.length > 0 && (
        <div>
          <p className="text-gray-700 text-sm mb-2">Columns Detected:</p>
